    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAggregateRoot", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorsBooks", x => new { x.BooksId, x.authorsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rentals", x => new { x.CustomerId, x.BookCopyId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rentals_CustomerAggregateRoot_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "CustomerAggregateRoot",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
